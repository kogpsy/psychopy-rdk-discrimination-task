...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/andrew/GitHub/teaching/psychopy-rdk-discrimination/rdk-discrimination_lastrun.py',
...
Fixation_pre_cueClock = core.Clock()
...
cue_text = visual.TextStim(win=win, name='cue_text',
    text='',
    font='Open Sans',
    pos=(0, 0.021), height=0.17, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);

# Initialize components for Routine "Fixation_post_cue"
Fixation_post_cueClock = core.Clock()
...
Instruction_MainClock = core.Clock()
...
for thisPractice_block_loop in practice_block_loop:
    ...
    for thisComponent in ISIComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('static_isi.started', static_isi.tStart)
    practice_block_loop.addData('static_isi.stopped', static_isi.tStop)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    Fixation_pre_cueClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "Fixation_pre_cue"-------
    while continueRoutine:
        # get current time
        t = Fixation_pre_cueClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=Fixation_pre_cueClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if fixation_pre.status == STARTED:
            ...
            if tThisFlipGlobal > fixation_pre.tStartRefresh + fixation_duration_pre_cue-frameTolerance:
                ...
                win.timeOnFlip(fixation_pre, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in Fixation_pre_cueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('fixation_pre.started', fixation_pre.tStartRefresh)
    practice_block_loop.addData('fixation_pre.stopped', fixation_pre.tStopRefresh)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *cue_text* updates
        if cue_text.status == NOT_STARTED and frameN >= 0:
            # keep track of start time/frame for later
        ...
        if cue_text.status == STARTED:
            if frameN >= (cue_text.frameNStart + 60):
                # keep track of stop time/frame for later
    ...
    for thisComponent in CueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('cue_text.started', cue_text.tStartRefresh)
    practice_block_loop.addData('cue_text.stopped', cue_text.tStopRefresh)
    ...
    t = 0
    _timeToFirstFrame = win.getFutureFlipTime(clock="now")
    Fixation_post_cueClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
    frameN = -1
    
    # -------Run Routine "Fixation_post_cue"-------
    while continueRoutine:
        # get current time
        t = Fixation_post_cueClock.getTime()
        tThisFlip = win.getFutureFlipTime(clock=Fixation_post_cueClock)
        tThisFlipGlobal = win.getFutureFlipTime(clock=None)
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        ...
        if fixation_post.status == STARTED:
            ...
            if tThisFlipGlobal > fixation_post.tStartRefresh + fixation_duration_post_cue-frameTolerance:
                ...
                win.timeOnFlip(fixation_post, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in Fixation_post_cueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('fixation_post.started', fixation_post.tStartRefresh)
    practice_block_loop.addData('fixation_post.stopped', fixation_post.tStopRefresh)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if dots_background.status == STARTED:
            if frameN >= (dots_background.frameNStart + 90):
                ...
                win.timeOnFlip(dots_background, 'tStopRefresh')  # time at next scr refresh
        ...
        if dots_keyboard_response.status == STARTED:
            if frameN >= (dots_keyboard_response.frameNStart + 90):
                ...
                win.timeOnFlip(dots_keyboard_response, 'tStopRefresh')  # time at next scr refresh
    ...
    for thisComponent in DotsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('dots_background.started', dots_background.tStartRefresh)
    practice_block_loop.addData('dots_background.stopped', dots_background.tStopRefresh)
    practice_block_loop.addData('dots_stimulus.started', dots_stimulus.tStartRefresh)
    practice_block_loop.addData('dots_stimulus.stopped', dots_stimulus.tStopRefresh)
    # check responses
    ...
    practice_block_loop.addData('dots_keyboard_response.started', dots_keyboard_response.tStartRefresh)
    practice_block_loop.addData('dots_keyboard_response.stopped', dots_keyboard_response.tStopRefresh)
    ...
    for thisComponent in FeedbackComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    practice_block_loop.addData('feedback_text.started', feedback_text.tStartRefresh)
    practice_block_loop.addData('feedback_text.stopped', feedback_text.tStopRefresh)
    thisExp.nextEntry()
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
Instruction_MainClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "Instruction_Main"-------
while continueRoutine:
    # get current time
    t = Instruction_MainClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=Instruction_MainClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
for thisComponent in Instruction_MainComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
thisExp.addData('instruction_main_text.started', instruction_main_text.tStartRefresh)
thisExp.addData('instruction_main_text.stopped', instruction_main_text.tStopRefresh)
# check responses
...
thisExp.addData('instruction_main_keyboard_response.started', instruction_main_keyboard_response.tStartRefresh)
thisExp.addData('instruction_main_keyboard_response.stopped', instruction_main_keyboard_response.tStopRefresh)
thisExp.nextEntry()
...
for thisMain_blocks_loop in main_blocks_loop:
    ...
    for thisComponent in ISIComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('static_isi.started', static_isi.tStart)
    main_blocks_loop.addData('static_isi.stopped', static_isi.tStop)
    ...
    for thisComponent in Fixation_pre_cueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('fixation_pre.started', fixation_pre.tStartRefresh)
    main_blocks_loop.addData('fixation_pre.stopped', fixation_pre.tStopRefresh)
    # the Routine "Fixation_pre_cue" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisComponent in CueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('cue_text.started', cue_text.tStartRefresh)
    main_blocks_loop.addData('cue_text.stopped', cue_text.tStopRefresh)
    ...
    for thisComponent in Fixation_post_cueComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('fixation_post.started', fixation_post.tStartRefresh)
    main_blocks_loop.addData('fixation_post.stopped', fixation_post.tStopRefresh)
    # the Routine "Fixation_post_cue" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisComponent in DotsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('dots_background.started', dots_background.tStartRefresh)
    main_blocks_loop.addData('dots_background.stopped', dots_background.tStopRefresh)
    main_blocks_loop.addData('dots_stimulus.started', dots_stimulus.tStartRefresh)
    main_blocks_loop.addData('dots_stimulus.stopped', dots_stimulus.tStopRefresh)
    # check responses
    if dots_keyboard_response.keys in ['', [], None]:  # No response was made
        dots_keyboard_response.keys = None
    ...
    main_blocks_loop.addData('dots_keyboard_response.started', dots_keyboard_response.tStartRefresh)
    main_blocks_loop.addData('dots_keyboard_response.stopped', dots_keyboard_response.tStopRefresh)
    ...
    for thisComponent in FeedbackComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    main_blocks_loop.addData('feedback_text.started', feedback_text.tStartRefresh)
    main_blocks_loop.addData('feedback_text.stopped', feedback_text.tStopRefresh)
    thisExp.nextEntry()
